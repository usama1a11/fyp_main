                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: IconButton(
                                  onPressed: toggleWishlist,
                                  icon: Icon(
                                    isInWishlist?Icons.favorite:Icons.favorite_outlined,
                                    color: isInWishlist ? Colors.red : Colors.white, // Color changes based on state
                                  ),
                                ),
                              ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              "\$${double.parse(widget.products.price.toString())}",
                        ...
                        Row(
                          children: [
                            ...
                            }, child: Text("Read Review",style: GoogleFonts.ubuntu(
                                color: Colors.black,
                                fontSize: 20,
                                fontWeight: FontWeight.bold),)),
                          ],
                          ...
                          child: InkWell(
                            onTap: () {
                              PersistentShoppingCart()
                                ...
                                Fluttertoast.showToast(
                                    msg:
                                    "Product not removed from cart $error");
                              });
                            },
                            child: Center(
                                child: Text(
                            ...
                            onTap: () {
                              PersistentShoppingCart()
                                ...
                                PersistentShoppingCartItem(
                                  ...
                                  productDescription:
                                  currentProduct.description,
                                  unitPrice: double.parse(currentProduct
                                      .price
                                      .toString()),
                                  productThumbnail: currentProduct.image, quantity: 1,
                                ),
                              )
                                  .then((value) {
                                Fluttertoast.showToast(
