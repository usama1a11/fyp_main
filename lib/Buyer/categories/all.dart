...
class _AllState extends State<All> with SingleTickerProviderStateMixin{
  ...
  final List<Map<String, dynamic>> allCategories = [
    ...
    {"name": "Chair", "icon": Icons.event_seat_outlined},
    {"name": "Table", "icon": Icons.table_restaurant_outlined},
    {"name": "Sofa", "icon": Icons.chair_outlined},
  ...
  void initState() {
    ...
    // Ensure the TabController is initialized safely
    if (allCategories.isNotEmpty) {
      ...
      throw Exception("allCategories list cannot be empty.");
    }
  }
  @override
  void dispose() {
                      ...
                      child: Center(
                        ...
                        GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return gridViewCard(AllProducts[index]);
                              },
                            ),
                      ),
                    ),
  ...
  Widget gridViewCard(Products products) {
    ...
    void _toggleFavorite(bool isFavorite) async {
      if (isFavorite) {
        ...
        await _databaseReference.orderByChild("id").equalTo(products.id).once().then((snapshot) {
