                ...
                child: SizedBox(
                  ...
                  child:GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return gridViewCard(ChairProducts[index]);
                        },
                      ),
                ),
              ),
                  ...
                  Stack(
                    children: [
                      Center(
                        child: InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => Detail(products: Products(
                              title: products.title,
                              price: products.price,
                              image: products.image,
                              id: products.id, review: '',description: products.description,
                            ),)));
                          },
                          child: Container(
                            height: 150,
